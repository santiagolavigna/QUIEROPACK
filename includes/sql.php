   ...
   if(tableExists('calculos'))
   {
     ...
     //   . "IF(pegados.id IS NULL,'0',pegados.id) AS id_pegados,IF(pegados.precio IS NULL,'0',pegados.precio) AS pegados_price "
          ...
          $sql = $db->query(
             ...
             . "fletes.precio flete_price, troquelados.precio troquelado_price, troquelados.descripcion troquelado_name, "
             . "empaquetados.precio empaquetado_price,empaquetados.descripcion empaquetado_name, puestas.precio puesta_price, puestas.descripcion puesta_name,"
             ...
             . "puestas.id id_puesta, onecolor.id id_onecolor, twocolor.id id_twocolor, pegados.id id_pegados, pegados.precio pegados_price, pegados.descripcion pegado_name,"
             . "pegamentos.id id_pegamentos,pegamentos.precio_kilo precio_kilo, pegamentos.cantidad pegamento_cantidad, pegamentos.porcentaje porcentaje,pegamentos.descripcion pegamento_name "             
